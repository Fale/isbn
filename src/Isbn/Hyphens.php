    ...
    private function getRegistrantElement()
    {
        ...
        switch ($soFar) {
            ...
            case '978-601':
                ...
                break;
            case '978-602':
                $this->range(      0,  799999, 2, 2);
                $this->range( 800000,  899999, 4, 2);
                $this->range( 900000, 1099999, 4, 2);
            ...
            case '978-605':
                ...
                $this->range( 100000,  299999, 2, 2);
                $this->range( 300000,  399999, 3, 2);
                $this->range( 400000,  999999, 2, 2);
            ...
            case '978-955':
                ...
                break;
            case '978-956':
                $this->range(      0,  899999, 2, 2);
                $this->range( 900000,  999999, 5, 2);
                $this->range(1000000, 1999999, 2, 2);
                $this->range(2000000, 5999999, 3, 2);
            ...
            case '978-9958':
                $this->range(      0,  199999, 2, 2);
                $this->range( 200000,  299999, 3, 2);
                $this->range( 300000,  399999, 4, 2);
